...
export default function DiscordButton({
  ...
  return (
    <button
      ...
      className={`w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-lg font-semibold transition-colors ${className}`}
    >
      <svg
        className="w-5 h-5"
        viewBox="0 0 24 24"
